...
export const tutorials = [
  "1. Grant the app permission to access the camera for capturing your pose.",
  "2. Choose your desired yoga position from the dropdown menu. ",
  "3. Familiarize yourself with the pose instructions to understand the proper execution.",
  '4. Initiate the pose by clicking "Start," observe the pose image on the right, and replicate it in front of the camera. ',
  "5. Achieve accuracy, and witness the skeleton overlay turning green on the video, accompanied by the commencement of soothing sounds.",
];

export const fixCamera = [
  "Solution 1. Ensure that camera permissions are granted. If denied, navigate to your browser settings to enable camera access for the application. ",
  "Solution 2. Verify that no other applications are currently using the camera. If another application is active, please close it. ",
  "Solution 3. Attempt to shut down all other open browsers to enhance camera functionality.",
];
